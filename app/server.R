...
server = function(input, output, session) {
  ...
  observeEvent(input$run, {
    ...
    shinyjs::disable("taxa_button_bin")
  ...
  observeEvent(input$divCalcRun, {
    ...
    shinyjs::enable("taxa_button_bin")
  ...
  ######################################
  observeEvent(input$taxa_button_bin,{
    ...
    withProgress(
      ...
      detail = 'This may take a while...', value = 0, {
        ...
        if (input$chooseMethod_taxa == "Welch t-test") {
          ...
          output$what_the = renderUI({
            
            box(title = strong("Dendrogram"), width = NULL, solidHeader = TRUE, status = "primary", 
                
                fluidRow(width = 600, align = "center", 
                         div(style = "display: inline-block:vertical-align:top;", grVizOutput("we_are_friend", width = "98%", height = 1000))),
                br(),
          ...
          output$we_are_friend= renderGrViz({
          ...
          output$how_are_you= renderUI({
            tagList(
              tabBox(title = strong("Box Plot", style = "color:black"), width = NULL,
                     tabPanel("Phylum", align = "center",
                              plotOutput("rank1", height = height[1]*250, width = 750),
                     )
                     ,
                     tabPanel("Class", align = "center",
                              plotOutput("rank2", height = height[2]*250, width = 750),
                     )
                     ,tabPanel("Order", align = "center",
                               plotOutput("rank3", height = height[3]*250, width = 750),
                     )
                     ,tabPanel("Family", align = "center",
                               plotOutput("rank4", height = height[4]*250, width = 750),
                     )
                     ,tabPanel("Genus", align = "center",
                               plotOutput("rank5", height = height[5]*250, width = 750),
                     )
                     ,tabPanel("Species", align = "center",
                               plotOutput("rank6", height = height[6]*250, width = 750),
                     )
              )
            )
          })
